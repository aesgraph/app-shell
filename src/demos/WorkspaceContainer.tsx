...
/**
 * Test menu component with tab testing actions
 */
const TestMenu: React.FC = () => {
  ...
  const addTestTabWithProps = () => {
    console.log("Adding tab with props: { testData: 'Hello from props!' }");
    addViewAsTab({
    ...
    const TestComponentWithProps = () => {
      ...
      return (
        ...
        >
          ...
          >
            <h4 style={{ color: theme.colors.text }}>Received Props:</h4>
          ...
          >
            <h4 style={{ color: theme.colors.text }}>Specific Props:</h4>
